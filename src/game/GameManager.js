...
class GameManager {
  constructor(baseUrl = './dist/') {
    ...
    // Load and manage game images - using full URLs where your assets are hosted
    this.images = {
      bucket: this.loadImage(`${baseUrl}bucket.svg`),
      teardrop: this.loadImage(`${baseUrl}BlueTear.png`),
