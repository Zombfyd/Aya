module 0x8e9187b49143e6071d8bdee63e34224a8e79fdaa6207d2d2ed54007c45936e0b::aya {
    ...
    public entry fun init(arg0: AYA, arg1: &mut tx_context::TxContext) {
        let decimals: u8 = 6;
        let symbol: vector<u8> = b"AYA";
        let name: vector<u8> = b"Aya Asagiri";
        let description: vector<u8> = x"";
        let icon_url: url::Url = url::new_unsafe_from_bytes(
